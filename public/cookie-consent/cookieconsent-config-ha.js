        ...
        translations: {
            de: {
                consentModal: {
                    ...
                    footer: `
                        <a href="https://historia-arcana.eu/impressum/" target="_blank">Impressum</a>
                        <a href="https://historia-arcana.eu/datenschutzerklaerung/" target="_blank">Datenschutzerklärung</a>
                    `,
                },
                preferencesModal: {
                            ...
                            linkedCategory: 'necessary',
                          	cookieTable: {
                                ...
                                body: [
                                    {
                                        name: 'cc_cookie',
                                        domain: 'historia-arcana.eu',
                                        path: '/',
                                        expirationDate: '2025-04-13T20:08:58.000Z',
